...
if __name__ == '__main__':
    ...
    print("Loading data...")
    DATA_DIR='data'
    vle    = pd.read_csv(f'{DATA_DIR}/full_student_vle.csv')
    assess = pd.read_csv(f'{DATA_DIR}/studentAssessment.csv')
    info   = pd.read_csv(f'{DATA_DIR}/studentInfo.csv')
    vle_dict = pd.read_csv(f'{DATA_DIR}/vle.csv')
    assess_dict = pd.read_csv(f'{DATA_DIR}/assessments.csv')
